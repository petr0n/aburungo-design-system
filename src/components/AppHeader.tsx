  ...
  return (
    <header className="mx-auto w-full max-w-3xl border-b-[6px] border-rule-on-inverse bg-inverse">
      {/* Back to the content column, 2026-08-22, and this reverses the change
          ...
          mark to the window edge, it is that a page band and a product bar are
          two different things. `GlobalHeader` is the one that spans the window
          and carries the brand; this one names the screen you are on.
