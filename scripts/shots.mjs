...
const SURFACES = [
  ...
  ['type-specimen', '/preview/10-type-phrase-specimen.html', 900, 500],
  ['spacing', '/preview/11-spacing-scale.html', 760, 420],
  ['radii', '/preview/12-radii.html', 900, 620],
  ['elevation', '/preview/13-elevation.html', 760, 300],
  ['touch-targets', '/preview/14-touch-targets.html', 760, 360],
  ['accent-usage', '/preview/16-accent-usage.html', 900, 900],
  ['segmented', '/preview/18-segmented.html', 760, 240],
  ['banners', '/preview/19-banners.html', 760, 280],
  ['icon-buttons', '/preview/21-icon-buttons.html', 760, 260],
  ['iconography', '/preview/26-iconography.html', 900, 300],
  ['voice-rules', '/preview/27-voice-rules.html', 900, 640],
  ...
  ['sandbox-ground', '/preview/_sandbox/ground-1-unjudged.html', 1500, 2400],
